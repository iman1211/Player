...
keyframe.load_motion_file(cwd.."/"..Config.km.side_kiri,
                          "SideLeft");
keyframe.load_motion_file(cwd.."/"..Config.km.medium_side_kanan,
                          "MediumSideRight");
keyframe.load_motion_file(cwd.."/"..Config.km.medium_side_kiri,
                          "MediumSideLeft");
...
function entry()
  ...
  elseif kickType == "MediumSideRight" then
    keyframe.do_motion("MediumSideRight");
  elseif kickType == "MediumSideLeft" then
    keyframe.do_motion("MediumSideLeft");
