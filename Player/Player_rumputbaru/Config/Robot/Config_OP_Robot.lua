...
stance.footXSit = 0.045;
stance.bodyTiltSit = -1*math.pi/180;
stance.bodyHeightSit = 0.338;
stance.qLArmSit = math.pi/180*vector.new({90,30,-5});
stance.qRArmSit = math.pi/180*vector.new({90,-30,-5});
