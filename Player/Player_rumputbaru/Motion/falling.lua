...
function entry()
  print(_NAME.." entry");
  Body.set_head_command({0,-2.5});

  -- relax all the joints while falling
  -- Body.set_body_hardness(0);
  Body.set_larm_hardness({0,0,0});
  Body.set_rarm_hardness({0,0,0});
  Body.set_lleg_hardness({0.0,0.0,0,0,0,0});
  Body.set_rleg_hardness({0.0,0.0,0,0,0,0});
